                                                ...
                                                html.Div(
                                                    [
                                                        ...
                                                        html.Ol(
                                                            [
                                                                html.Li(
                                                                    "Input a stock ticker and click 'Verify Ticker'.",
                                                                    style={
                                                                        "color": COLORS[
                                                                            "text"
                                                                        ]
                                                                ...
                                                                html.Li(
                                                                    "Explore the stock's recent news and historical performance.",
                                                                    style={
                                                                        "color": COLORS[
                                                                            "text"
                                                                        ]
                                                                ...
                                                                html.Li(
                                                                    "Choose to add it to your portfolio.",
                                                                    style={
                                                                        "color": COLORS[
                                                                            "text"
                                                                        ]
...
def verify_and_display(_, ticker):
    ...
    if trigger_id == "btn-verify-ticker":
        ...
        logo_url_with_key = result["logo_url_with_key"]
        ...
        return (
            ...
            company_metadata_layout(
                company_info, branding, logo_url_with_key, address, COLORS
            ),
        )
