...
def plot_efficient_frontier(
    ...
    efficient_frontier_fig.update_layout(
        ...
        xaxis=dict(
            ...
            color=COLORS["text"],
            tickformat=".2%",
            range=[min(frontier_stddevs) - 0.0005, max(frontier_stddevs) + 0.0005],
            showgrid=True,
        ...
        yaxis=dict(
            ...
            color=COLORS["text"],
            tickformat=".2%",
            range=[min(frontier_returns) - 0.0005, max(frontier_returns) + 0.0005],
            showgrid=True,
            gridcolor="rgba(0, 130, 180, 0.2)",
        ),
